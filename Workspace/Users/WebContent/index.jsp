	...
	<div id="sidebar">
		<div id="login" class="boxed">
			...
			<div id="innerLogin" class="content">
				<form id="login" method="post" autocomplete="off" action="loginAction2.jsp">
					<fieldset>
					<legend>Sign-In</legend>
					<label for="UID">UID:</label><br />
					<input id="UID" type="text" name="UID" value="" autofocus/>
	...
	<div id="main">
		...
		<div id="example" class="post">
			...
			<div class="story">
				...
				<p>
				So if you haven't already registered, go regsiter for WAI today!
				</p>
			</div>
		</div>
	</div>
