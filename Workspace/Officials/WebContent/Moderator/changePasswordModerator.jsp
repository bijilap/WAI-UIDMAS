...
xmlhttp.send();
	...
	<body>
                    ...
                    <div class="grid_12">
                        <div id="logo">
                             <ul id="nav">
                                ...
                                <li id="current"><a href="changePassword">Change Password</a></li>
                            </ul>
                        </div><!-- End. #Logo -->
                    </div><!-- End. .grid_12-->
                    <div style="clear: both;"></div>
        ...
        <font size="+5" color="#0066FF">Change your password by providing the current password and enetering the new password of your choice.</font>
        </div>        
        </p>
                <br />
		<div class="module">
...
<form action="javascript:loadSubmitForm('passwordChange','changePasswordActionModerator.jsp')" method="get" id="passwordChange" autocomplete="off">
