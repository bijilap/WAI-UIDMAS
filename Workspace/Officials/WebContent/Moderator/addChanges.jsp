          ...
          <div style="clear:both;"></div>
            ...
            <div class="grid_12">
               ...
               <%
                   ...
                   String QueryString = "SELECT db2admin.UPDATE_FORM.UID,db2admin.UPDATE_FORM.FNAME,db2admin.UPDATE_FORM.LNAME FROM db2admin.UPDATE_FORM, db2admin.NOMINAL_ROLL WHERE db2admin.UPDATE_FORM.UID=db2admin.NOMINAL_ROLL.UID";//WHERE MODERATOR_ID!=modid
                ...
                <div class="module">
                    ...
                    <div class="module-table-body" id="replacebody">
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    <th width="25%" style="width:25%">UID</th>
                                    <th width="25%" style="width:25%">First Name</th>
                                    <th width="25%" style="width:25%">Last Name</th>        
                             ...
                             while (rs.next()) 
                              {%> 
                                <tr>
                                    ...
                                    <td>
										<a href="" onmouseover="approveChange('approveChange.jsp?uid=<%=rs.getString("UID")%>')" >Approve</a>                           
                                    </td>
                                </tr>
                            <%
                            }
