...
try
{
	if(approve.equals("yes"))
	{
		...
		checksumGenerator csg=new checksumGenerator();
		String checksum="'"+csg.genCheckSum()+"'";
		QueryString= "UPDATE DB2ADMIN.NOMINAL_ROLL SET CHECKSUM="+checksum+" WHERE UID='"+uid+"'";
		st.executeUpdate(QueryString);
		System.out.println(s);
