...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript">
			...
			xmlhttp.onreadystatechange=function()
			  ...
			  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			    {
				var initialText="<br/>"+document.getElementById("successNotification").innerHTML;
			    document.getElementById("successNotification").innerHTML=xmlhttp.responseText+initialText;
			    }
			  }			
	...
	<body>
		...
		<div class="container_12">
            ...
            <!-- Dashboard icons -->
          <div class="grid_7">
            	<a href="javascript:backup('backup.jsp')" class="dashboard-module">
                	<img src="Resources/backup.png" width="64" height="64" alt="edit" />
                	<span>Back Up</span>
                </a>
                
                <a href="javascript:backup('restore.jsp')" class="dashboard-module">
                	<img src="Resources/restore.png" width="64" height="64" alt="edit" />
                	<span>Restore</span>
                </a>
                <div style="clear: both"></div>
            </div> <!-- End .grid_7 -->
          ...
          <div style="clear:both;"></div>
            ...
            <div class="grid_12">
                ...
                <div class="module">
                  <h2>Back Up &amp; Restore Centre</h2>
                  <div align="center" id="successNotification">
	                  <p>&nbsp;Welcome to the Back Up &amp; Restore Centre. Your stop for one click database backup. Perform a Back Up atleast once a day.         </p>
	                  <p>&nbsp;</p>
	                  <!-- End .module-body -->
				  </div>
              </div>
          ...
          <div style="clear:both;"></div>
            ...
            <div class="grid_3"></div><!-- End .grid_6 -->
